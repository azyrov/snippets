...
// // notice how we can use forEach for the exact same process
// // that said, we'd have to init the array then push into it
// // map creates an array and places the returned array items to this new array 
  // arr.forEach((item) => {
